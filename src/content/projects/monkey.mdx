...
blurb: Modeling, rigging and animating a body for Suzanne the monkey and importing it into Unity.
skills:
- unity
- blender
start: 2022-12-01
...
For this project I wanted to implement a pipeline from Blender to Unity that I would be able to rely on for future game development. I was able to get the rig going quickly with the Rigify extension so I was more focused on how to organize animations and format them for Unity. I still have a lot to learn in this realm but it was a good way to dip my toes and expand my toolbox!
